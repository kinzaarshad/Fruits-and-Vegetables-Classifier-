...
import com.example.fruitsandvegetables.ml.FruitsModel
import com.example.fruitsandvegetables.util.YuvToRgbConverter
import com.example.fruitsandvegetables.viewmodel.Recognition
import com.example.fruitsandvegetables.viewmodel.RecognitionListViewModel
...
class ClassifyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<FloatingActionButton>(R.id.click).setOnClickListener{ view ->
            clicked=true;
            //finish()
        }
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            imageAnalyzer = ImageAnalysis.Builder()
                ...
                .also { analysisUseCase: ImageAnalysis ->
                    analysisUseCase.setAnalyzer(cameraExecutor, ImageAnalyzer(this) { items ->
                        ...
                        //print(items);
                        if(clicked==true){
                            val intent = Intent(this@ClassifyActivity,Result::class.java)
                            //print(preview.camera.);
                            intent.putExtra("Result",items[0].label)
                            finish()
            ...
            val cameraSelector = if (cameraProvider.hasCamera(CameraSelector.DEFAULT_BACK_CAMERA)) CameraSelector.DEFAULT_BACK_CAMERA else CameraSelector.DEFAULT_FRONT_CAMERA
    ...
    private class ImageAnalyzer(ctx: Context, private val listener: RecognitionListener) :
        ...
        // method is called.
        private val fruitsModel: FruitsModel by lazy{
            ...
            FruitsModel.newInstance(ctx, options)
        }
        ...
        override fun analyze(imageProxy: ImageProxy) {
            ...
            val outputs = fruitsModel.process(tfImage)
